...
class MirrorsFreeAggregatingBuilder implements Builder {
  ...
  Future<bool> _hasEntryPointAnnotation(LibraryElement library) async {
    for (final element in library.topLevelElements) {
      if (element is ClassElement) {
        final hasEntryPoint = element.metadata.any((meta) =>
            meta.element?.displayName == 'DireDiEntryPoint');
        if (hasEntryPoint) {
          return true;
        }
      }
  ...
  Future<List<ComponentInfoWithSource>> _collectAllComponents(BuildStep buildStep) async {
  ...
  Future<void> _processFile(AssetId assetId, BuildStep buildStep, List<ComponentInfoWithSource> allComponents) async {
    try {
      ...
      final componentsWithSource = components.map((c) => ComponentInfoWithSource(
  ...
  String _generateConsolidatedCode(List<ComponentInfoWithSource> components, AssetId inputId) {
    ...
    buffer.writeln();
    buffer.writeln('// **************************************************************************');
    buffer.writeln('// DireDi Mirrors-Free Generator');
    buffer.writeln('// **************************************************************************');
    buffer.writeln();
    buffer.writeln('// GENERATED CODE - DO NOT MODIFY BY HAND');
    buffer.writeln('// Generated by dire_di mirrors-free code generator');
    ...
    buffer.writeln('  /// Register all discovered components from the entire project');
  ...
  List<ComponentInfoWithSource> _sortComponentsByDependencies(List<ComponentInfoWithSource> components) {
  ...
  String _generateComponentRegistration(ComponentInfoWithSource component) {
    ...
    if (component.constructorDependencies.isEmpty && component.autowiredFields.isEmpty) {
      ...
      for (final field in component.autowiredFields) {
        buffer.writeln('        instance.${field.fieldName} = get<${field.type}>();');
      }
